...
const HeaderLP = () => {
    return (
        <div className="w-[calc(100%-1rem)] sm:w-[calc(100%-2rem)] mt-20 overflow-hidden relative mx-auto h-[60vh] lg:h-[calc(100vh-156px)] lg:mt-20 bg-gray-100 flex flex-col md:justify-center md:items-end dark:bg-[#292929] rounded-2xl header-sq gap-5 p-5">
        <div className="grid grid-cols-4 self-start md:grid-cols-6 gap-2 w-full h-[60%] md:h-full z-3">
            ...
            <div className="flex items-center col-start-1 md:col-start-4 lg:col-start-5 col-end-7 lg:col-end-7 self-start md:self-center md:row-span-3 tablet-col-3">
                <p className='lg:text-[1.2rem] text-md font-light'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Tempore facilis itaque porro, hic dicta quidem nihil, debitis aperiam ipsa maiores accusamus odio excepturi provident nisi voluptas eius dolorum?</p>
            </div>
